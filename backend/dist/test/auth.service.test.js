...
describe('Auth Service', () => {
    ...
    describe('loginUserWithEmailAndPassword', () => {
        ...
        it('should throw error for incorrect password', async () => {
            await expect(authService.loginUserWithEmailAndPassword(testData.testUser.email, 'wrongpassword')).rejects.toThrow('Incorrect email or password');
        });
        it('should throw error for non-existent user', async () => {
            await expect(authService.loginUserWithEmailAndPassword('nonexistent@example.com', 'password123')).rejects.toThrow('Incorrect email or password');
        });
    });
    describe('logout', () => {
