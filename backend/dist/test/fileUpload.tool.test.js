...
import { fileUploadTools } from "../tools/fileUpload.tool.js";
...
describe('FileUpload MCP Tools', () => {
    let testUser;
    const [initiateUploadTool, completeUploadTool, getUploadTool, queryUploadsTool, deleteUploadTool, validateFileTool] = fileUploadTools;
    beforeAll(async () => {
    ...
    describe('completeUploadTool', () => {
        ...
        it('should throw error for non-existent upload', async () => {
            ...
            await expect(completeUploadTool.fn({ uploadId: fakeUploadId, userId: testUser.id })).rejects.toThrow('Upload not found');
        });
    });
    describe('getUploadTool', () => {
        ...
        it('should throw error for non-existent upload', async () => {
            const fakeUploadId = '12345678-1234-1234-1234-123456789012';
            await expect(getUploadTool.fn({ uploadId: fakeUploadId, userId: testUser.id })).rejects.toThrow('Upload not found');
        });
    });
    ...
    describe('deleteUploadTool', () => {
        ...
        it('should throw error for non-existent upload', async () => {
            const fakeUploadId = '12345678-1234-1234-1234-123456789012';
            await expect(deleteUploadTool.fn({ uploadId: fakeUploadId, userId: testUser.id })).rejects.toThrow('Upload not found');
        });
    });
    ...
    describe('Tool Error Handling', () => {
        ...
        it('should handle duplicate completion attempts', async () => {
            ...
            await expect(completeUploadTool.fn({
                uploadId: result.uploadId,
                userId: testUser.id
