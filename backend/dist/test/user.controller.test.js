...
const setupTestData = async () => {
    ...
    const userAccessToken = await tokenService.generateAuthTokens({ id: testUser.id });
    const adminAccessToken = await tokenService.generateAuthTokens({ id: testAdmin.id });
    return {
        testUser,
        testAdmin,
...
describe('User Controller', () => {
    ...
    describe('PATCH /v1/users/:userId', () => {
        let testUserForUpdate;
        beforeEach(async () => {
            testUserForUpdate = await userService.createUser('updatetest@example.com', 'password123', 'Update Test User', Role.USER);
        });
    ...
    describe('DELETE /v1/users/:userId', () => {
        ...
        beforeEach(async () => {
            testUserForDelete = await userService.createUser('deletetest@example.com', 'password123', 'Delete Test User', Role.USER);
        });
