...
describe('MCP Tools', () => {
    ...
    beforeAll(async () => {
        ...
        // Create test users
        testUser = await userService.createUser('mcp-tool-user@example.com', 'password123', 'MCP Tool Test User', Role.USER);
    ...
    describe('Manage Context Tool', () => {
        ...
        it('should throw error for unsupported action', async () => {
            ...
            await expect(manageContextTool.fn(inputs)).rejects.toThrow('Context action unsupported_action not implemented');
        });
    });
