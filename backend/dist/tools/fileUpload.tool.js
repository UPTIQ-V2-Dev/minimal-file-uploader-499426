...
const initiateUploadTool = {
    ...
    inputSchema: z.object({
        ...
        fileType: z
            ...
            'text/plain',
            'text/csv'
        ].includes(type), { message: 'Unsupported file type' }),
    ...
    fn: async (inputs) => {
        const result = await fileUploadService.initiateUpload(inputs.fileName, inputs.fileType, inputs.fileSize, inputs.userId);
        return result;
    }
};
const completeUploadTool = {
