...
describe('User Service', () => {
    ...
    describe('createUser', () => {
        ...
        it('should throw error if email already exists', async () => {
            ...
            await expect(userService.createUser(userData.email, userData.password, 'Another User')).rejects.toThrow(
                'Email already taken'
            );
        });
    ...
    describe('updateUserById', () => {
        ...
        it('should throw error if email already taken', async () => {
            ...
            await expect(userService.updateUserById(testUser.id, { email: 'existing@example.com' })).rejects.toThrow(
                'Email already taken'
            );
        });
