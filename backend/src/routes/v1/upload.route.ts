import { fileUploadController } from '../../controllers/index.ts';
import auth from '../../middlewares/auth.ts';
import validate from '../../middlewares/validate.ts';
import { fileUploadValidation } from '../../validations/index.ts';
...
router.post(
    '/initiate',
    auth('uploadFiles'),
    validate(fileUploadValidation.initiateUpload),
    fileUploadController.initiateUpload
);
router.post(
    '/complete',
    auth('uploadFiles'),
    validate(fileUploadValidation.completeUpload),
